# Cluster-Beere: Kubernetes-Cluster mit dem Raspberry Pi

Dies ist das begleitende GitHub-Repository zum Artikel "Cluster Beere, Kubernetes-Cluster mit dem Raspberry Pi", erschienen im c't Magazin, Ausgabe 25/2024 und bei heise+.

Mit dem Playbook in diesem Repository konfigurieren Sie einen hochverfügbaren Kubernetes-Cluster aus 4 Raspberry Pi auf Basis von k3s, kube-vip und MetalLB, größtenteils automatisiert dank Ansible. 

Es ist eine angepasste Kopie dieses Repository von Timothy Stewart (aka @TechnoTim). Grundlage davon waren dieser Fork, der wiederum auf diesem k3s-Projekt aufbaut. Die ursprüngliche README-Datei finden Sie unter READMEv1.md
